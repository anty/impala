...
//this class corresponding to class with same name  written in java
//in order to read a HFile file format, first thing has to be done is  to retrieve FixedFileTrailer at the end of file.
...
public:
	...
	int64_t load_on_open_data_offset_;
